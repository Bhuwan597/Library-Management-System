...
const Footer = () => {
    return (<>
            <div className="border-t border-solid border-gray-500 my-8 w-1/4 mx-auto"></div>
                ...
                <div className="mx-auto max-w-screen-xl px-4 py-2 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-8 border-t border-gray-100 pt-8">
                        <div className="sm:flex sm:justify-between">
                            <p className="text-xs text-gray-500">&copy; 2024. Akhil KranitKari. All rights reserved.</p>
