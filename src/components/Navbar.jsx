                ...
                <Dropdown placement="bottom-end">
                    <DropdownTrigger>
                        <Button isIconOnly variant="light" className='text-white'>
                            <FaRegBell className='relative text-xl'/>
                            <span className='absolute top-2 right-2 w-3 h-3 rounded-full bg-blue-500'></span>
                        </Button>
                    </DropdownTrigger>
                    <DropdownMenu
                    ...
                    >
                        <DropdownItem description={'Notification 1'}>
                        </DropdownItem>
                        <DropdownItem description={'Notification 2'}>
                        </DropdownItem>
                        <DropdownItem description={'Notification 3'}>
                        </DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </Navbar>
